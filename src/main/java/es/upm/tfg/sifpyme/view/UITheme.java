...
public class UITheme {
    ...
    public static final String ICONO_BUSCAR = "\u1F50D"; // 🔍
    public static final String ICONO_VER = "\u1F441"; // 👁
    public static final String ICONO_ESTABLECER = "\u2B50"; // ⭐
    public static final String ICONO_CONFIG = "\u1F527"; // 🔧
    public static final String ICONO_SALIR = "\u1F6AA"; // 🚪
    public static final String ICONO_AGREGAR_LINEA = "\u002B"; // +
    ...
    public static Color getColorPrimario(String modulo) {
        switch (modulo.toLowerCase()) {
            case "empresas": return COLOR_EMPRESAS;
            case "clientes": return COLOR_CLIENTES;
            case "productos": return COLOR_PRODUCTOS;
            case "facturas": return COLOR_FACTURAS;
            case "menu": return COLOR_MENU_PRINCIPAL;
    ...
    public static String getIconoModulo(String modulo) {
        switch (modulo.toLowerCase()) {
            case "empresas": return ICONO_EMPRESAS;
            case "clientes": return ICONO_CLIENTES;
            case "productos": return ICONO_PRODUCTOS;
            case "facturas": return ICONO_FACTURAS;
            case "menu": return ICONO_MENU;
            default: return "";
        }
    }
    
    /**
     * Crea un ícono de FontAwesome o similar (para uso futuro con librerías de íconos)
     */
